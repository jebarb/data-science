...
text %>%
  tolower() %>%
  str_extract_all("(?<=[^bcdfghjklmnpqrstvwxyz])[bcdfghjklmnpqrstvwxyz]{2,}(?=[^bcdfghjklmnpqrstvwxyz])") %>% 
  unlist()
```
