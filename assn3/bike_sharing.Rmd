...
hum_atemp_lm <- lm(cnt ~ hum + atemp, hour11)
summary(hum_atemp_lm)
plot(hum_atemp_lm, which = 1:2)

cnt_month_lm <- lm(atemp ~ cnt + mnth, hour11)
summary(cnt_month_lm)
plot(cnt_month_lm, which = 1:2)
