...
Hermione does tend to co-occur with Harry
...
The linear model indicates that there does appear to be a relationship between Hermione being mentioned alongside Ron and Harry.
